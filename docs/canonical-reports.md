...
| Payouts to bank | `GET_V2_SETTLEMENT_REPORT_DATA_FLAT_FILE_V2` | `brain.settlements` + `brain.settlement_lines` | Settlement | 14-day rolling | **active** (CLI: `npm run ingest-settlements`). Auto-generated by Amazon — connector lists DONE reports and ingests anything new |
